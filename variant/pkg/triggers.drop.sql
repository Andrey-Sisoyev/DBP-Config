...
DROP TRIGGER tri_configlng_onmodify          ON configurations_bylngs;
...
DROP TRIGGER tri_confparamlngvalue_l_onmodify ON configurations_parameters_lngvalues__leafs;
...
DROP TRIGGER tri_z_lngconfig_oncredel        ON configurations_bylngs;
...
DROP TRIGGER tri_z_confparamlngvalue_l_oncredel ON configurations_parameters_values__leafs;
...
DROP TRIGGER tri_a_confentity_ondelete       ON configurable_entities;
DROP FUNCTION confentity_ondelete();

DROP TRIGGER tri_configsbylngs_autocreate    ON configurations_bylngs;
DROP FUNCTION configsbylngs_autocreate();
