...
\echo NOTICE >>>>>> Create tables where testcases will be kept and functions to insert and cleanup test cases.
\echo

------------------------------------------------------------------------------
------------------------------------------------------------------------------

CREATE OR REPLACE FUNCTION pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__delete_dummies() RETURNS integer
...
CREATE OR REPLACE FUNCTION pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__create_dummies() RETURNS integer
SET search_path = sch_<<$app_name$>> -- , comn_funs, public
LANGUAGE plpgsql
AS $$
DECLARE rows_cnt integer;
...
BEGIN
        PERFORM pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__delete_dummies();
...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE test1__cparameters_values TO user_db<<$db_name$>>_app<<$app_name$>>_data_admin;

-----------------------------------------------------------

CREATE OR REPLACE FUNCTION pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__delete_testcases_of_t1(par_tc_id integer) RETURNS integer
SET search_path = sch_<<$app_name$>> -- , comn_funs, public
LANGUAGE plpgsql
AS $$
DECLARE rows_cnt integer;
...
CREATE OR REPLACE FUNCTION pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__create_testcases_of_t1(par_tc_id integer) RETURNS integer
SET search_path = sch_<<$app_name$>> -- , comn_funs, public
LANGUAGE plpgsql
AS $$
DECLARE rows_cnt      integer;
        n integer;
BEGIN
        PERFORM pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__delete_testcases_of_t1(par_tc_id);
...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE test2__confentities TO user_db<<$db_name$>>_app<<$app_name$>>_data_admin;
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE test2__rels         TO user_db<<$db_name$>>_app<<$app_name$>>_data_admin;

-------------------------------------

CREATE OR REPLACE FUNCTION pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__delete_testcases_of_t2(par_tc_id integer) RETURNS integer
SET search_path = sch_<<$app_name$>> -- , comn_funs, public
LANGUAGE plpgsql
AS $$
DECLARE rows_cnt integer;
...
CREATE OR REPLACE FUNCTION pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__create_testcases_of_t2(par_tc_id integer) RETURNS integer
SET search_path = sch_<<$app_name$>> -- , comn_funs, public
LANGUAGE plpgsql
AS $$
DECLARE rows_cnt      integer;
...
BEGIN
        PERFORM pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__delete_testcases_of_t2(par_tc_id);
...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE test3__cparameters_values TO user_db<<$db_name$>>_app<<$app_name$>>_data_admin;

-------------------

CREATE OR REPLACE FUNCTION pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__delete_testcases_of_t3(par_tc_id integer) RETURNS integer
SET search_path = sch_<<$app_name$>> -- , comn_funs, public
LANGUAGE plpgsql
AS $$
DECLARE rows_cnt integer;
...
CREATE OR REPLACE FUNCTION pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__create_testcases_of_t3(par_tc_id integer) RETURNS integer
SET search_path = sch_<<$app_name$>> -- , comn_funs, public
LANGUAGE plpgsql
AS $$
DECLARE rows_cnt      integer;
        ...
        last_par      integer;
BEGIN
        PERFORM pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__delete_testcases_of_t3(par_tc_id);
...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE test4__cparameters_values TO user_db<<$db_name$>>_app<<$app_name$>>_data_admin;

-------------------

CREATE OR REPLACE FUNCTION pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__delete_testcases_of_t4(par_tc_id integer) RETURNS integer
SET search_path = sch_<<$app_name$>> -- , comn_funs, public
LANGUAGE plpgsql
AS $$
DECLARE rows_cnt integer;
...
CREATE OR REPLACE FUNCTION pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__create_testcases_of_t4(par_tc_id integer) RETURNS integer
SET search_path = sch_<<$app_name$>> -- , comn_funs, public
LANGUAGE plpgsql
AS $$
DECLARE rows_cnt      integer;
        super_id      integer;
BEGIN
        PERFORM pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__delete_testcases_of_t4(par_tc_id);
...
CREATE OR REPLACE FUNCTION pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__delete_testcases_of_t5(par_tc_id integer) RETURNS integer
SET search_path = sch_<<$app_name$>> -- , comn_funs, public
LANGUAGE plpgsql
AS $$
DECLARE rows_cnt integer;
...
CREATE OR REPLACE FUNCTION pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__create_testcases_of_t5(par_tc_id integer) RETURNS integer
SET search_path = sch_<<$app_name$>> -- , comn_funs, public
LANGUAGE plpgsql
AS $$
DECLARE rows_cnt      integer;
        ...
        last_par      integer;
BEGIN
        PERFORM pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__delete_testcases_of_t5(par_tc_id);
...
CREATE TABLE pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__test_cases__ (testcase_id integer PRIMARY KEY, testcase_type integer);
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__test_cases__ TO user_db<<$db_name$>>_app<<$app_name$>>_data_admin;

--------------------------

CREATE OR REPLACE FUNCTION pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__delete_testcases(par_tc_id integer) RETURNS integer
SET search_path = sch_<<$app_name$>> -- , comn_funs, public
LANGUAGE plpgsql
AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__create_testcases(par_tc_id integer) RETURNS integer
SET search_path = sch_<<$app_name$>> -- , comn_funs, public
LANGUAGE plpgsql
AS $$
BEGIN
        PERFORM pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__delete_testcases(par_tc_id);

        CASE
            WHEN par_tc_id >   0 AND par_tc_id < 100 THEN
                PERFORM pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__create_testcases_of_t1(par_tc_id);
            WHEN par_tc_id > 100 AND par_tc_id < 200 THEN
                PERFORM pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__create_testcases_of_t2(par_tc_id);
            WHEN par_tc_id > 200 AND par_tc_id < 300 THEN
                PERFORM pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__create_testcases_of_t3(par_tc_id);
            WHEN par_tc_id > 300 AND par_tc_id < 400 THEN
                PERFORM pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__create_testcases_of_t4(par_tc_id);
            WHEN par_tc_id > 400 AND par_tc_id < 500 THEN
                PERFORM pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__create_testcases_of_t5(par_tc_id);
            ELSE RAISE EXCEPTION 'Test case #% not classified.', par_tc_id;
        END CASE;
...
CREATE OR REPLACE FUNCTION pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__delete_all_testcases() RETURNS integer
SET search_path = sch_<<$app_name$>> -- , comn_funs, public
LANGUAGE plpgsql
AS $$
BEGIN
        PERFORM pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__delete_testcases(atc.testcase_id)
        FROM pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__test_cases__ AS atc;
...
CREATE OR REPLACE FUNCTION pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__create_all_testcases() RETURNS integer
SET search_path = sch_<<$app_name$>> -- , comn_funs, public
LANGUAGE plpgsql
AS $$
BEGIN
        PERFORM pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__delete_all_testcases();

        PERFORM pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__create_testcases(atc.testcase_id)
        FROM pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__test_cases__ AS atc;
...
-- data ----------------------------------------------------------------------
------------------------------------------------------------------------------
\i tests.prepare.mini_testcases.sql
-- This \/ takes too long (((
-- \i tests.prepare.true_testcases.sql
...
SELECT pkg_<<$pkg.name_p$>>_<<$pkg.ver_p$>>__create_all_testcases();
